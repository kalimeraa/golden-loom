...
',
      'ru' => '<p style="color:#000">Прозрачные ткани – это легкие, полупрозрачные материалы, которые пропускают свет, обеспечивая при этом определенный уровень уединения. Они широко используются для штор, драпировок и декоративных элементов в интерьере. Вот несколько ключевых деталей о прозрачных тканях:</p>
